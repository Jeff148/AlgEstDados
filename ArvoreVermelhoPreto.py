...
for x in lista:
    a = nodo(x)
    deposito.adicionar(a)

print(deposito.getRoot().getDado())
deposito.rbDelete(deposito.getRoot())
deposito.transferir(deposito.getRoot(), deposito)
print(deposito.getRoot().getDado())

deposito.inOrder()
print(deposito.ino)
deposito.reset(deposito)

print(deposito.getRoot().getEsquerdo().getDado())
